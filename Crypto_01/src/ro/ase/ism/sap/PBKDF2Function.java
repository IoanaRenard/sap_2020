...
public class PBKDF2Function {
	...
	public PBKDF2Function(
			int noIterations, int outputHashSize, String algorithm, String provider) {
	...
	public byte[] getHash(char[] userPassword, byte[] salt)
		...
		PBEKeySpec key = 
				new PBEKeySpec(userPassword, salt, noIterations, outputHashSize);
